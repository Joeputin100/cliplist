...
- **Theme & icon:** brand is **teal `#0E7C7B` → lime `#A8CF45`** (chosen 2026-05-30; matches the app icon). Material 3 dynamic color (API 31+) with this teal/lime fallback; follows system light/dark, overridable in Settings. Adaptive launcher icon (vector foreground "play built from EQ bars" + gradient background + monochrome) wired in `:app`; Play Store icon at `docs/mockups/play_store_icon_512.png`.
